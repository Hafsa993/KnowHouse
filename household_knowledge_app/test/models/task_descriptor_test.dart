...
void main() {
  ...
  group('Category Functions Tests', () {
    test('should return correct colors for categories', () {
      expect(getCategoryColor('Cooking'), equals(Colors.red));
      expect(getCategoryColor('Gardening'), equals(Colors.green));
      expect(getCategoryColor('Shopping'), equals(Colors.amber[600]));
      expect(getCategoryColor('Planning'), equals(const Color.fromARGB(255, 145, 74, 189)));
      expect(getCategoryColor('Care'), equals(const Color.fromARGB(255, 255, 93, 212)));
      expect(getCategoryColor('Maintenance'), equals(const Color.fromARGB(255, 100, 155, 159)));
      expect(getCategoryColor('Other'), equals(const Color.fromARGB(255, 155, 144, 173)));
    });

    test('should return default blue color for unknown category', () {
      expect(getCategoryColor('Unknown'), equals(Colors.blue));
      expect(getCategoryColor(''), equals(Colors.blue));
    });
